...
export default function About() {
  return (
    <section id="about" className="p-8 bg-slate-200">
      <hr />
      <h2 className="text-slate-800 font-montserrat font-extrabold text-5xl text-center mt-20">
        About Me📑
      </h2>
      <div className="flex justify-around mb-14">
        ...
        <p className="text-slate-800 text-xl w-5/12 mt-28 ">
          👋 Hello! I'm Bharanimanikandan, a recent MCA graduate with hands-on
          experience in web development. <br /> 💻 I completed a 3-month
          internship at Shiash Info Solutions, Chennai, where I worked on a
          fascinating project named 'Text Steganography'. During this
          internship, I honed my skills in HTML, CSS, JavaScript.And also i
